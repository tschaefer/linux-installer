...
Linux::Installer::Filesystem::Ext3 - Provides a filesystem class.

=head1 SYNOPSIS

    use Linux::Installer::Filesystem::Ext3;
    use Log::Log4perl;

    Log::Log4perl->init('conf/installer.log.conf');

    my $ext3 = Linux::Installer::Filesystem::Ext3->new(
        {
            device => '/dev/sda3',
        }
    );
...
Creates ext3 filesystem and disables periodic checks.
